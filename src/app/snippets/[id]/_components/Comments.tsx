        ...
        <div className="space-y-6">
          {comments === undefined ? (
            <div className="animate-pulse space-y-6">
              {[1, 2, 3].map((n) => (
                <div key={n} className="bg-[#0a0a0f] rounded-xl p-6 border border-[#ffffff0a]">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-full bg-[#ffffff08]" />
                    <div className="flex-1">
                      <div className="h-4 bg-[#ffffff08] rounded w-24 mb-2" />
                      <div className="h-3 bg-[#ffffff08] rounded w-32" />
                    </div>
                  </div>
                  <div className="h-16 bg-[#ffffff08] rounded" />
                </div>
              ))}
            </div>
          ) : comments.length === 0 ? (
            <div className="bg-[#0a0a0f] rounded-xl p-6 text-center border border-[#ffffff0a]">
              <p className="text-[#808086]">No comments yet. Be the first to comment!</p>
            </div>
          ) : (
