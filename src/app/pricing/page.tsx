      ...
      <main className="relative pt-32 pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div
              className="absolute -inset-px bg-gradient-to-r from-yellow-500
             to-amber-500 rounded-2xl blur opacity-10"
            />
            <div className="relative bg-gradient-to-b from-[#12121a]/90 to-[#0a0a0f]/90 backdrop-blur-xl rounded-2xl">
              <div
                className="absolute inset-x-0 -top-px h-px bg-gradient-to-r 
              from-transparent via-yellow-500/50 to-transparent"
              />
              <div className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-amber-500/50 to-transparent" />

              <div className="relative p-8 md:p-12">
                {/* header */}
                <div className="text-center mb-12">
                  <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-yellow-500/10 to-amber-500/10 ring-1 ring-yellow-900/30 mb-6">
                    <Star className="w-8 h-8 text-yellow-400" />
                  </div>
                  <h2 className="text-3xl font-semibold text-white mb-4">Lifetime Pro Access</h2>
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    <span className="text-2xl text-gray-400">₹</span>
                    <span className="text-6xl font-semibold bg-gradient-to-r from-yellow-200 to-amber-200 text-transparent bg-clip-text">
                      1099
                    </span>
                    <span className="text-xl text-gray-400">one-time</span>
                  </div>
                  <p className="text-gray-400 text-lg">Unlock the full potential of CodeStudio</p>
                </div>
